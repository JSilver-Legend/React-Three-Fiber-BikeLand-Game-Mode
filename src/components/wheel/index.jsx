...
const Wheel = forwardRef(({ radius, leftSide, isVislble, scale, ...props }, ref) => {
  ...
  useCylinder(() => ({ mass: 1, type: 'Kinematic', material: 'wheel', collisionFilterGroup: 0, args: [radius, radius, 0.1, 16], ...props }), ref)

  return (
    <mesh ref={ref}>
      <mesh scale={scale} rotation={[0, 0, ((leftSide ? 1 : -1) * Math.PI) / 2]} visible={isVislble}>
