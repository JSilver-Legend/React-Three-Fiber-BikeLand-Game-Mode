...
const HomePage = () => {
  ...
  return (
    ...
    >
      ...
      <OrbitControls target={[0, 0, 5]} minDistance={10} maxDistance={10} minAzimuthAngle={2 * Math.PI / 8} maxAzimuthAngle={2 * Math.PI / 8} minPolarAngle={2.3 * Math.PI / 8} maxPolarAngle={2.3 * Math.PI / 8} />
    </Canvas>
  )
}
