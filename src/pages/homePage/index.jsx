    ...
    >
      ...
      <group scale={[1, 1.5, 1]}>
        <Physics>
          ...
          <mesh castShadow receiveShadow geometry={nodes.building_3.geometry} material={materials.city_2} position={[4.9, -0.130, 8.9]} />
          <mesh castShadow receiveShadow geometry={nodes.building_4.geometry} material={materials.city_2} position={[2, -0.06, 10.9]} />
          <mesh castShadow receiveShadow geometry={nodes.building_5.geometry} material={materials.city_2} position={[1.85, -0.12, 9.9]} scale={[0.7, 0.9, 0.8]} />
          <mesh castShadow receiveShadow geometry={nodes.building_6.geometry} material={materials.city_2} position={[2, -0.1, 14.3]} />
          <mesh castShadow receiveShadow geometry={nodes.building_7.geometry} material={materials.city_2} position={[2.05, -0.1, 16]} />
          <mesh castShadow receiveShadow geometry={nodes.building_8.geometry} material={materials.city_2} position={[2.05, -0.15, 19]} />
          <mesh castShadow receiveShadow geometry={nodes.building_9.geometry} material={materials.city_2} position={[-2.5, 0.05, 9]} scale={[1.5, 1.6, 1.5]} />
          <mesh castShadow receiveShadow geometry={nodes.building_10.geometry} material={materials.city_2} position={[-2.5, -0.06, 10.8]} />
          <mesh castShadow receiveShadow geometry={nodes.building_11.geometry} material={materials.city_2} position={[-3.4, -0.14, 13.4]} />
          <mesh castShadow receiveShadow geometry={nodes.building_12.geometry} material={materials.city_2} position={[-3.4, -0.1, 14.4]} />
          <mesh castShadow receiveShadow geometry={nodes.building_13.geometry} material={materials.city_2} position={[-2.1, -0.35, 19.2]} scale={[1.5, 1.5, 1.5]} />
          <mesh castShadow receiveShadow geometry={nodes.building_14.geometry} material={materials.city_2} position={[-3.1, -0.1, 20.3]} />
      ...
      <OrbitControls target={[0, 0, 5]} minDistance={5} maxDistance={30} minAzimuthAngle={2 * Math.PI / 8} maxAzimuthAngle={2 * Math.PI / 8} minPolarAngle={2.3 * Math.PI / 8} maxPolarAngle={2.3 * Math.PI / 8} />
    </Canvas>
  )
}
